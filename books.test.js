...
beforeEach(async () => {
    let result = await db.query(
        ...
        VALUES ('123456789', 'https://amazon.com/book', 
                            'TK', 
                            'English', 
                            100, 
                            'The Pub', 
...
describe("POST /books", function(){
    ...
    test("Prevents book creation without required info", async function(){
        const result = await request(app).post("/books").send({year:2000});
